            ...
            <div class="card-body p-5">
              ...
              <form (ngSubmit)="registrar()">
                ...
                <div class="mb-4">
                  ...
                  <select class="form-select shadow-sm rounded-3" [(ngModel)]="data.id_perfil" name="perfil">
                    <option [ngValue]="3"><i class="bi bi-tree"></i> Campesino (vender productos)</option>
                    <option [ngValue]="4"><i class="bi bi-cart"></i> Consumidor (comprar productos)</option>
                  </select>
                </div>
...
export class Register {
  ...
  data = { nombres: '', apellidos: '', cedula: '', email: '', celular: '', password: '', id_perfil: 3 };
  error = '';
  cargando = false;
